...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--2017-10-08 ebb: This is the second of a "pipeline" series of 3 stylesheets designed to be run in sequence, with the goal of moving left_margin zone elements to sit in sequence next to their insertion points. We need a pipeline process because there are left_margin zone insertions indicated *inside* two left_margin zones, leading these to be improperly processed if we attempt the migration of these zones in one stylesheet process. (See comment of 2017-09-26 describing the problem.)
  In this SECOND stylesheet, we work only with zones that are not in the margins, and we move left_margin zones (already processed and modified in the previous sheet) into place into the other document zones (main text or others). 
  -->
...
<!--2017-10-08 ebb: This is what we processed in the previous stylesheet: 
