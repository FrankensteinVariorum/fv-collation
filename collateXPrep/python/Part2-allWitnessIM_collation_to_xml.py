...
for name in glob.glob('../collChunks-Part2/1818_fullFlat_*'):
    try:
        ...
        with open(name, 'rb') as f1818file, \
            ...
            collation_input = {"witnesses": [f1818_tokenlist, f1823_tokenlist, fThomas_tokenlist, fMS_tokenlist, f1831_tokenlist]}
