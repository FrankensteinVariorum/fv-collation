...
for name in glob.glob('../collChunks-Part8/1818_fullFlat_*'):
    try:
        ...
        with open(name, 'rb') as f1818file, \
                open('../collChunks-Part8/1823_fullFlat_' + matchString, 'rb') as f1823file, \
                open('../collChunks-Part8/Thomas_fullFlat_' + matchString, 'rb') as fThomasfile, \
                open('../collChunks-Part8/1831_fullFlat_' + matchString, 'rb') as f1831file, \
                open('../collChunks-Part8/msColl_' + matchString, 'rb') as fMSfile, \
                open('../Full_Part8_xmlOutput/collation_' + matchStr + '.xml', 'w') as outputFile:
            ...
            collation_input = {"witnesses": [f1818_tokenlist, f1823_tokenlist, f1831_tokenlist, fThomas_tokenlist, fMS_tokenlist]}
