...
for name in glob.glob('collChunkFrags_c58Frag/1818_fullFlat_*'):
    try:
        ...
        with open(name, 'rb') as f1818file, \
                open('collChunkFrags_c58Frag/Thomas_fullFlat_' + matchString, 'rb') as fThomasfile, \
                open('collChunkFrags_c58Frag/1823_fullFlat_' + matchString, 'rb') as f1823file, \
                open('collChunkFrags_c58Frag/1831_fullFlat_' + matchString, 'rb') as f1831file, \
                open('collChunkFrags_c58Frag/msColl_' + matchString, 'rb') as fMSfile, \
                open('collChunkFrags_c58Frag/msColl_c58_' + matchString, 'rb') as fMSc58file, \
                open('collChunkFrags_c58Frag/msColl_c58Frag_' + matchString, 'rb') as fMSc58Fragfile, \
            ...
            collation_input = {"witnesses": [f1818_tokenlist, fThomas_tokenlist, f1823_tokenlist, f1831_tokenlist, fMS_tokenlist, fMSc58_tokenlist, fMSc58Frag_tokenlist]}
