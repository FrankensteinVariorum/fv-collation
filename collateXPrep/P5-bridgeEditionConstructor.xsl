...
<!--2018-06-26: NOT WORKING: This is Bridge Construction Phase 5: Here we "unpack" the self-closed <seg> elements marking hotspots, and where their ends are marked in following elements, we reconstruct them in pieces. We also deliver the seg identifying locations to the Spinal Column file. -->    
   <xsl:template match="/">
