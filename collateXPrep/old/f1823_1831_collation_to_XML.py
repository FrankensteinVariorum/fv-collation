...
for name in glob.glob('c56_FlagcollationChunks/1823_fullFlat_*'):
    ...
    with open(name, 'rb') as f1823file, \
            open('c56_FlagcollationChunks/1831_fullFlat_' + matchString, 'rb') as f1831file, \
            open('f1823_1831_FlagXMLOutput/collation_' + matchStr + '.xml', 'w') as outputFile:
        ...
        collation_input = {"witnesses": [f1823_tokenlist, f1831_tokenlist]}
