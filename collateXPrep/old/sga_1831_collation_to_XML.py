...
for name in glob.glob('c56_FlagcollationChunks/1831_fullFlat_*'):
    ...
    with open(name, 'rb') as f1831file, \
            open('c56_FlagcollationChunks/msColl_c56Flagged_' + matchString, 'rb') as fMSc56file, \
            open('sga_1831_FlagXMLOutput/collation_' + matchStr + '.xml', 'w') as outputFile:
        ...
        collation_input = {"witnesses": [fMSc56_tokenlist, f1831_tokenlist]}
