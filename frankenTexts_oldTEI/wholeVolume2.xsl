...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
        ...
        <TEI xmlns="http://www.tei-c.org/ns/1.0">
            <teiHeader>
                <fileDesc>
                    ...
                    <publicationStmt>
                        <idno type="edition">frank27.1831</idno>
                    ...
                    <sourceDesc>
                        <biblStruct>
                            <monogr>
                                ...
                                <imprint>
                                    <publisher>
                                        <name>Henry Colburn</name> and <name>Richard Bentley</name>
                                    </publisher>
                                    <pubPlace>London</pubPlace>
                                    <date>1831</date>
                                    <biblScope type="ed">Rev., Corr. [2nd ed.]</biblScope>
    ...
    <xsl:template match="tei:text">
        <xsl:variable name="volch">
            <xsl:value-of select="substring-after(ancestor-or-self::tei:TEI/tei:teiHeader/tei:fileDesc/tei:publicationStmt/tei:idno[@type='edition'], 'frank27.1831')"/>
        </xsl:variable>
